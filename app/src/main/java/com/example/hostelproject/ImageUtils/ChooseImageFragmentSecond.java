...
public class ChooseImageFragmentSecond extends DialogFragment {
    ...
    public interface OnInputListener {
        void sendInputSecond(byte[] bytes);
    }


    public static ChooseImageFragmentSecond.OnInputListener mOnInputListener2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressBar2 = view.findViewById(R.id.progress_bar_Dialog);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_PIC_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            BackgroundImageResize backgroundImageResize = new BackgroundImageResize(getActivity(), ChooseImageFragmentSecond.this);
            backgroundImageResize.execute(uriId);
    ...
    public void onAttach(Context context) {
        ...
        try {
            mOnInputListener2 = (ChooseImageFragmentSecond.OnInputListener) getActivity();
